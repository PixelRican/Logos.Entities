...
namespace Monophyll.Entities.Tests
{
	internal sealed class EntityRegistryEntityManagementTest : IUnitTest
	{
		public void Run()
		{
			...
			Debug.Assert(chunk1.GetEntities()[0] == entity1);
			Debug.Assert(chunk2.GetEntities()[1] == entity2);
			...
			Debug.Assert(chunk2.GetEntities()[0] == entity2);
			...
			Debug.Assert(chunk1.GetEntities()[^1] == entity1);
